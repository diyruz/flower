...
// The last 16 bytes of the last available page are reserved for flash lock
// bits. NV page definitions must coincide with segment declaration in project
// *.xcl file.
...
/* ------------------------------------------------------------------------------------------------
 *  Serial Boot Loader: reserving the first 4 pages of flash and other memory in
 * cc2530-sb.xcl.
 * ------------------------------------------------------------------------------------------------
 */
...
// Size of internal flash less 4 pages for boot loader, 6 pages for NV, & 1 page
// for lock bits.
